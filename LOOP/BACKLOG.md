...
### R111. `distill_log_line` crashes the DEFAULT view on a non-dict `message` — `open` `self-promoted`
...
### R112. Mobile docs lag the distilled-default rollout (Android README + DESIGN §3.2 + API §4) — `open` `self-promoted`
