...
bare kotlinc + JUnit (verified 2026-06-05, 26/26 green on Kotlin 1.9.24):
...
Verified 2026-06-05: `assembleDebug` + `testDebugUnitTest` (31 tests) pass with
JDK 17, Gradle 8.9, and SDK cmdline-tools (platform 35, build-tools 34) — no
Studio needed:
